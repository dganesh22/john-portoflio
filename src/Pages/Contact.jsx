                ...
                <div className="col-md-6 col-lg-4 col-sm-12">
                    <div className="card mt-5">
                      <div className="card-header">
                          <h6 className="display-6 text-success text-center">My Info</h6>
                      </div>
                      <div className="card-body">
                          <ul className="list-group">
                            ...
                            <li className="list-group-item">
                              <strong>Email</strong>
                              <span className="float-end text-success">contact@gmail.com</span>
                            </li>
                            <li className="list-group-item">
                              <strong>Mobile</strong>
                              <span className="float-end text-success">9988776655</span>
                            </li>
                          </ul>
                      </div>
                    </div>
